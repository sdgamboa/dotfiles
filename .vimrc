...
map <F2> :w!<CR> 
    ...
    \ :execute "!pandoc -s --quiet --highlight-style breezedark -f markdown -t html -o " . my_var . ".html " . expand('%:p')<CR>
    \ :execute "!dillo -f " . my_var . ".html > /dev/null 2> /dev/null&"<CR><CR>

" Refresh an existing html file with markdown and pandoc
map <F3> :w!<CR>
    \ :let my_var = expand('%:p:r')<CR>
    \ :execute "!pandoc -s --quiet --highlight-style breezedark -f markdown -t html -o " . my_var . ".html " . expand('%:p')<CR><CR>
